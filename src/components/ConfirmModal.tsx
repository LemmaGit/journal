...
export const ConfirmModal: React.FC<ConfirmModalProps> = ({
    ...
    switch (type) {
      ...
      case "warning":
        return {
          ...
          confirmBtn:
            "bg-amber-600 hover:bg-amber-700 shadow-amber-600/20 focus:ring-amber-500",
        };
      case "info":
        return {
          ...
          confirmBtn:
            "bg-indigo-600 hover:bg-indigo-700 shadow-indigo-600/20 focus:ring-indigo-500",
        };
      case "danger":
      default:
        return {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      {/* Backdrop */}
      <div
        className="absolute inset-0 bg-slate-900/60 dark:bg-black/60 --backdrop-blur-md transition-opacity duration-300"
        onClick={onCancel}
      />
      ...
      <div className="relative bg-white dark:bg-slate-900/90 border border-slate-200/80 dark:border-slate-800/80 rounded-3xl max-w-sm w-full p-6 shadow-2xl overflow-hidden animate-slide-up --backdrop-blur-xl">
        ...
        <div className="flex gap-4 items-start pt-2">
          ...
          <div
            className={`p-3 rounded-2xl shrink-0 flex items-center justify-center ${styles.iconBg}`}
          >
            {styles.icon}
          </div>
